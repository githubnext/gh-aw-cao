...
| --- | --- | --- |
| Cannot read or execute CAO runtime | Runtime revision | Verify that the root CAO package installed `.github/workflows/shared/control.mjs` and `policy.mjs` and that both exist at the workflow revision. |
