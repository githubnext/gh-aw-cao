...
| Built-in page | `id`, `kind`, `page`, `title`, `navigation-label`, `navigation-indicator`, `description`, `icon`, `class-name`, `filter-bar`, `view-mode-control`, `form`, `definition` |
| Custom page | `id`, `kind`, `title`, `navigation-label`, `navigation-indicator`, `description`, `icon`, `class-name`, `filter-bar`, `view-mode-control`, `form`, `route`, `views`, `sections` |
