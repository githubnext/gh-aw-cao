...
| Built-in page | `id`, `kind`, `page`, `title`, `navigation-label`, `description`, `icon`, `class-name`, `form`, `definition` |
| Custom page | `id`, `kind`, `title`, `navigation-label`, `description`, `icon`, `class-name`, `form`, `route`, `views`, `sections` |
