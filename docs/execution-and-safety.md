...
2. Before activation, `.github/workflows/shared/control.md` uses the package-installed runtime from the exact-SHA shared checkout and runs the `admit` command against policy from that same workflow revision.
