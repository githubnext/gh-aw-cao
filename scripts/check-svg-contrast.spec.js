...
const svgFiles = envFiles
  ...
  : [
      ...findSvgFiles(path.join(repoRoot, "docs", "assets")),
      ...findSvgFiles(path.join(repoRoot, "public", "assets")),
    ];
    ...
    const measurements = await page.evaluate(() => {
      ...
      for (const textEl of textEls) {
        ...
        for (const bg of candidates) {
          ...
          const fillAttr =
            (computedFill && computedFill !== "none" ? computedFill : bg.getAttribute("fill")) || "";
