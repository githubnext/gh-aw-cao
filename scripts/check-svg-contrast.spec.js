      ...
      for (const textEl of textEls) {
        ...
        const candidates = Array.from(
          document.querySelectorAll(
            'svg rect, svg circle, svg ellipse, svg path, svg polygon',
          ),
        )
        ...
        for (const bg of candidates) {
          ...
          const fillAttr =
            (computedFill && computedFill !== 'none'
              ? computedFill
          ...
          const elementOpacity = parseFloat(
            bgStyle.opacity || bg.getAttribute('opacity') || '1',
          )
          const fillOpacity = parseFloat(
            bgStyle.fillOpacity || bg.getAttribute('fill-opacity') || '1',
          )
