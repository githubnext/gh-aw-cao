...
.notifications-pagination { display: flex; align-items: center; justify-content: flex-end; gap: 10px; padding: 8px 12px; border: 1px solid var(--border); border-top: 0; border-radius: 0 0 6px 6px; color: var(--muted); font-size: .75rem; }
.notifications-pagination[hidden] { display: none; }
.notifications-pagination button { min-height: 28px; padding: 3px 10px; border: 1px solid var(--border); border-radius: 6px; background: var(--canvas); color: var(--fg); font: inherit; font-weight: 600; }
.notifications-pagination button:disabled { color: var(--muted); cursor: not-allowed; opacity: .65; }
