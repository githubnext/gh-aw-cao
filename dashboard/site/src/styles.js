...
.entity-card-list-actions { display: flex; flex-wrap: wrap; gap: 6px; grid-column: 2 / -1; margin-top: 10px; } /* spans from the content column (col 2 of .issue-list-card's grid-template-columns) to the last column so it always forms its own full-width row instead of competing with the labels column for auto-placement */
