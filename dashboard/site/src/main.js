      ...
      const fixtureSources = /** @type {Record<string, import('./presenter.js').LogicalSourceInput>} */ ({
        ...
        workflows: {
          ...
          rows: [
            ...
            { organization: "githubnext", repository: "gh-aw-cao", package: "cao-evolution", "package-name": "CAO Evolution", "workflow-role": "worker", workflow: ".github/workflows/aw-maintenance-compiler-security.md", "workflow-name": "AW compiler security", "workflow-active": "true", "rollout-mode": "review", "max-ai-credits": 500, "inventory-ready": true, "observed-at": "2026-08-29T10:00:00Z" },
            { organization: "githubnext", repository: "gh-aw-cao", package: "cao-evolution", "package-name": "CAO Evolution", "workflow-role": "worker", workflow: ".github/workflows/aw-failures-investigator.md", "workflow-name": "AW failures investigator", "workflow-active": "true", "rollout-mode": "review", "max-ai-credits": 500, "inventory-ready": true, "observed-at": "2026-08-29T10:00:00Z" },
        ...
        runs: {
          ...
          rows: [
            ...
            { organization: "githubnext", repository: "gh-aw-cao", workflow: ".github/workflows/aw-maintenance-compiler-security.md", run: "2005", event: "workflow_dispatch", "run-title": "AW Compiler Security", "started-at": "2026-08-10T07:30:00Z", "run-status": "completed", "run-conclusion": "cancelled", "rollout-mode": "review", engine: "gpt", "requested-model": "gpt-4o-mini", "resolved-model": "gpt-4o-mini", "run-link": { relation: "run", href: "https://github.com/githubnext/gh-aw-cao/actions/runs/2005", label: "View run 2005" } },
          ],
        ...
        "work-items": {
          ...
          rows: [
            ...
            {
              "work-item-id": "cao-evolution:github/mona-tools:compiler-security-2026-09-05",
        ...
        "agent-assignments": {
          ...
          rows: [
            ...
            {
              "assignment-id": "assignment:cao-evolution-compiler-security:mona-tools",
              "agent-id": "cao-evolution-compiler-security",
              "agent-name": "CAO Evolution compiler security",
              "agent-state": "blocked",
              "work-item-id": "cao-evolution:github/mona-tools:compiler-security-2026-09-05",
              objective: "Upgrade agentic workflow dependencies",
              "assignment-state": "active",
        ...
        "control-plane-smells": {
          ...
          rows: [{
            ...
            organization: "githubnext",
            repository: "gh-aw-cao",
            workflow: ".github/workflows/cao-evolution.md",
