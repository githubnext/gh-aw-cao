...
const EXPERIMENTS_VIEW_COMPOSITIONS = /** @type {Readonly<Record<ExperimentsViewBody, ExperimentsViewComposition>>} */ ({
...
export function experimentsViewCompositionForBody(body) {
  return selectElementComposition(EXPERIMENTS_VIEW_COMPOSITIONS, EXPERIMENTS_VIEW_CONFIG, body);
}
...
export function defaultExperimentsViewComposition() {
  return EXPERIMENTS_VIEW_BODY_VALUES.map((body) => experimentsViewCompositionForBody(body));
}
