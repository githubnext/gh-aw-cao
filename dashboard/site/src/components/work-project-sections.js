/**
 * Shared declarative work-project section renderers.
 */
...
import { renderCountBadge, formatUtcDateTime } from './ui-primitives.js';
 ...
 * @returns {HTMLElement}
 */
export function renderWorkProjectBoard(items, section) {
  return h(
    'section',
 ...
 * @returns {HTMLElement}
 */
export function renderWorkProjectTasks(items, section) {
  return h(
    'section',
    { className: section.className, id: section.id, 'aria-label': section.landmarkLabel },
 ...
 * @returns {HTMLElement}
 */
export function renderWorkProjectRoadmap(items, section) {
