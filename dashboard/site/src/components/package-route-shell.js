  ...
  return [
    {
      ...
      label: 'Insights',
      icon: 'graph',
      href: `#page-package-insights${packageQuery}`,
    },
    {
      id: 'workflows',
      label: 'Workflows',
      icon: 'workflow',
      href: `#page-package-detail${packageQuery}`,
    },
    {
      id: 'dispatches',
      label: 'Dispatches',
      icon: 'play',
      href: `#page-package-dispatches${packageQuery}`,
    },
    {
      id: 'reports',
      label: 'Reports',
      icon: 'issue',
      href: `#page-package-reports${packageQuery}`,
    },
  ]
}
