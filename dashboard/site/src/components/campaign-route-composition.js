...
const CAMPAIGN_ROUTE_COMPOSITIONS = {
  overview: {
    ...
    description: 'Overview of the {campaignName} campaign.',
    currentTab: 'overview',
  ...
  workflows: {
    ...
    description: 'Orchestrator and worker workflows in the {campaignName} campaign.',
  ...
  issues: {
    ...
    description: 'Issues generated by the {campaignName} campaign.',
    currentTab: 'issues',
    bodyRenderer: undefined
  },
  'pull-requests': {
    ...
    description: 'Pull requests generated by the {campaignName} campaign.',
  ...
  runs: {
    ...
    description: 'Workflow runs for the {campaignName} campaign.',
    currentTab: 'runs',
    bodyRenderer: undefined
  },
  repositories: {
    ...
    description: 'Repositories associated with the {campaignName} campaign.',
  ...
  reports: {
    ...
    description: 'Durable reports produced by the {campaignName} campaign.',
    currentTab: 'reports',
    bodyRenderer: undefined
  }
};
