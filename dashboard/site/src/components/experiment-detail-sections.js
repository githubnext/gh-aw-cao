      ...
      h(
        ...
        ...metrics.map((metric) => {
          ...
          return h(
            ...
            renderEvalBar(
              experiment.control,
              matching.filter((row) => row.variant === experiment.control),
            ),
            renderEvalBar(
              experiment.candidate,
              matching.filter((row) => row.variant === experiment.candidate),
            ),
          )
        }),
      ),
      ...
      h(
        ...
        h(
          ...
          h(
            'div',
            null,
            h('span', null, 'Usable observations'),
