...
const STORAGE_KEY = scopedStorageKey('central-agentic-ops.dashboard.notifications');
const CATCH_UP_STORAGE_KEY = scopedStorageKey('central-agentic-ops.dashboard.last-catch-up');
const CATCH_UP_QUEUE_STORAGE_KEY = scopedStorageKey('central-agentic-ops.dashboard.catch-up-queue');
