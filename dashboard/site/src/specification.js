...
export const SOURCE_FIELDS = {
  ...
  'data-health-summary': ['confidence', 'reason', 'affected-domains', 'next-action', 'availability', 'completeness', 'freshness', 'scope-coverage', 'collector-state', 'compatibility-gaps'],
  ...
  'data-health-compatibility': ['source', 'workflow', 'producer-version', 'compatibility', 'missing-fields', 'missing-field-class', 'affected-domain', 'reason', 'next-action'],
  ...
  'work-items': ['work-item-id', 'objective', 'organization', 'repository', 'scope', 'domain', 'work-type', 'lifecycle-state', 'phase', 'reason', 'reason-evidence-class', 'next-action', 'next-actor', 'waiting-on', 'waiting-since', 'owner', 'consequence-tier', 'execution-state', 'verification-state', 'artifact-state', 'outcome-state', 'maturity-status', 'state-history', 'observed-at', 'evidence-link', 'repository-link', 'run-link'],
  'attention-signals': ['attention-signal-id', 'signal-type', 'work-item-id', 'objective', 'scope', 'reason', 'consequence', 'action', 'expected-actor', 'age-seconds', 'consequence-tier', 'priority', 'recovery-state', 'resolved-at', 'observed-at', 'evidence-link', 'repository-link', 'run-link'],
  'agent-assignments': ['assignment-id', 'agent-id', 'agent-name', 'agent-state', 'work-item-id', 'objective', 'assignment-state', 'handoff-state', 'dependency-state', 'conflict-state', 'started-at', 'ended-at', 'coordination-source', 'observed-at', 'evidence-link', 'repository-link', 'run-link'],
  'evidence-records': ['evidence-id', 'evidence-class', 'evidence-kind', 'work-item-id', 'objective', 'claim', 'verification-state', 'evidence-disposition', 'provenance-state', 'authority-state', 'execution', 'artifact-state', 'outcome-state', 'maturity-status', 'source-revision', 'observed-at', 'evidence-link', 'repository-link', 'run-link']
};
