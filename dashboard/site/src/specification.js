...
export const SOURCE_FIELDS = {
  ...
  'workflow-runs': ['workflow-route', 'organization', 'repository', 'workflow', 'run', 'run-title', 'event', 'started-at', 'ended-at', 'run-status', 'run-conclusion', 'run-card-status', 'run-check-summary', 'failure-job', 'failure-message', 'failure-step', 'rollout-mode', 'engine', 'engine-version', 'gh-aw-version', 'requested-model', 'resolved-model', 'run-link'],
