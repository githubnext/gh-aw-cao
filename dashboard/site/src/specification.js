...
export const TABLE_FIELDS = {
  ...
  'operational-values': ['organization', 'repository', 'repository-name', 'campaign', 'campaign-name', 'campaign-icon', 'operational-value', 'operational-value-definition', 'operational-value-role', 'operational-value-name', 'operational-value-direction', 'maturity-status', 'adoption-at', 'observed-at', 'organization-link', 'repository-link', 'campaign-link'],
