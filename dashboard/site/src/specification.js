...
export const FACTORY_HEADER_SOURCE_ROLES = ['status', 'campaigns', 'healthy-campaigns', 'rhythm'];
export const FACTORY_FLOOR_SOURCE_ROLES = ['campaigns', 'healthy-campaigns', 'registered-repository-summary', 'repository-coverage', 'issues', 'outcome-summary', 'run-summary', 'dispatch-summary', 'delivery-summary', 'value-summary', 'worker-summary'];
export const VIEW_ELEMENT_ANIMATION_VALUES = ['number'];
export const FACTORY_OVERVIEW_SECTION_VALUES = ['header', 'floor'];
export const FACTORY_FLOOR_STATION_VALUES = ['campaigns', 'repositories', 'issues', 'successful-runs', 'dispatches', 'value-gains'];
