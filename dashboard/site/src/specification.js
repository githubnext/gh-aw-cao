...
export const SOURCE_FIELDS = {
  ...
  'data-health-summary': ['confidence', 'reason', 'affected-domains', 'next-action', 'availability', 'completeness', 'freshness', 'scope-coverage', 'collector-state', 'compatibility-gaps', 'sources', 'available-sources', 'rows', 'fields', 'total-size', 'populated-cells', 'empty-cells', 'external-link'],
