...
export const QUERY_TEMPORAL_SERIES_KEYS = ['time', 'series', 'shape', 'carry', 'measures', 'maps', 'trend'];
...
export const QUERY_TEMPORAL_SERIES_TREND_KEYS = ['direction'];
...
export const BUILT_IN_PAGE_KEYS = ['id', 'kind', 'page', 'title', 'navigation-label', 'navigation-indicator', 'description', 'icon', 'class-name', 'experimental', 'filter-bar', 'view-mode-control', 'form', 'definition'];
export const CUSTOM_PAGE_KEYS = ['id', 'kind', 'title', 'navigation-label', 'navigation-indicator', 'description', 'icon', 'class-name', 'experimental', 'filter-bar', 'view-mode-control', 'form', 'route', 'views', 'sections'];
...
export const TABLE_FIELDS = {
  ...
  campaigns: ['id', 'campaign', 'campaign-name', 'campaign-description', 'campaign-icon', 'campaign-mode', 'campaign-enabled', 'campaign-registration', 'campaign-max-repositories', 'campaign-rollout-percent', 'campaign-aic-allowance', 'campaign-worker-count', 'campaign-inventory-warnings', 'campaign-workers', 'campaign-targets', 'campaign-min-version', 'campaign-version', 'campaign-current-version', 'campaign-update-state', 'campaign-experimental', 'campaign-readme-path', 'campaign-readme', 'observed-at', 'campaign-link'],
  ...
  experiments: ['organization', 'repository', 'campaign', 'workflow', 'experiment', 'experiment-name', 'control-variant', 'candidate-variant', 'primary-metric', 'primary-source', 'state', 'readiness', 'decision', 'normalized-effect', 'evidence-strength', 'last-observation', 'observed-at'],
  'experiment-assignments': ['organization', 'repository', 'campaign', 'workflow', 'run', 'experiment', 'variant', 'assignment-at', 'included', 'exclusion-reason', 'observed-at', 'assignment-link', 'artifact-link', 'trace-link'],
  ...
  'campaign-dispatch-state': ['campaign', 'campaign-name', 'dispatch-runs', 'skipped', 'failed', 'succeeded', 'worker-dispatches', 'aic', 'agent', 'model'],
  ...
  'repository-workflows': ['repository', 'workflow', 'workflow-name', 'workflow-role', 'campaign-name', 'rollout-mode', 'workflow-active', 'observed-at', 'aic', 'workflow-link'],
...
export const SOURCE_ENTITY_IDENTIFIER_FIELDS = {
  ...
  'campaign-reports': ['campaign', 'safe-output'],
