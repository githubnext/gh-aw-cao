...
export const SOURCE_FIELDS = {
  ...
  'token-efficiency-opportunities': ['organization', 'repository', 'workflow', 'run', 'opportunity-id', 'opportunity-kind', 'assignment-run', 'experiment', 'evidence-window-start', 'evidence-window-end', 'evidence-state', 'evidence-confidence', 'cost-grain', 'observed-at', 'evidence-link', 'repository-link', 'workflow-link', 'run-link'],
  'token-efficiency-interventions': ['organization', 'repository', 'workflow', 'run', 'opportunity-id', 'intervention-id', 'intervention-state', 'recommendation-disposition', 'supersedes-intervention-id', 'superseded-by-intervention-id', 'recommendation-churn-count', 'recommendation-churn-rate', 'experiment', 'control-variant', 'optimized-variant', 'proposed-savings-aic', 'accepted-at', 'observed-at', 'issue-link', 'pull-request-link', 'evidence-link', 'repository-link', 'workflow-link', 'run-link'],
