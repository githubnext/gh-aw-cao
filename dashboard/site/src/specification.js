...
export const VIEW_ELEMENT_CONFIG_KEYS = ['body', 'sections', 'labels', 'animate', 'view-all-page', 'view-all-label', 'label-field', 'link-field', 'icon-field', 'fallback-icon', 'empty-message'];
