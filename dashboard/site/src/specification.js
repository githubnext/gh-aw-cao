...
export const SOURCE_FIELDS = {
  ...
  events: ['organization', 'repository', 'workflow', 'run', 'run-attempt', 'session', 'event', 'event-timestamp', 'event-source', 'event-type', 'event-summary', 'event-status', 'correlation-id', 'payload-ref', 'source-sequence', 'observed-at', 'run-link'],
