...
export const SOURCE_FIELDS = {
  ...
  transactions: ['transaction', 'kind', 'created-at', 'payload-scope', 'payload-hash', 'payload-etag', 'records', 'committed-records', 'raw-payload-records', 'raw-runs', 'agentic-run-records', 'agentic-runs', 'duplicate-raw-run-observations', 'duplicate-agentic-run-observations', 'unenriched-runs', 'error'],
