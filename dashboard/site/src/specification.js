...
export const BUILT_IN_PAGE_KEYS = ['id', 'kind', 'page', 'title', 'navigation-label', 'navigation-indicator', 'description', 'icon', 'class-name', 'filter-bar', 'view-mode-control', 'form', 'definition'];
export const CUSTOM_PAGE_KEYS = ['id', 'kind', 'title', 'navigation-label', 'navigation-indicator', 'description', 'icon', 'class-name', 'filter-bar', 'view-mode-control', 'form', 'route', 'views', 'sections'];
