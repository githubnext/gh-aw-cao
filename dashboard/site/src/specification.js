...
export const UNIT_FORMAT_VALUES = ['duration', 'usd'];
...
export const SOURCE_FIELDS = {
  ...
  transactions: ['transaction', 'transaction-kind', 'created-at', 'status', 'repository', 'workflow', 'run', 'run-attempt', 'event-name', 'request-id', 'ref', 'sha', 'records', 'committed-records', 'run-link'],
