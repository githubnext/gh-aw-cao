...
export const SOURCE_FIELDS = {
  ...
  'grader-observations': ['organization', 'repository', 'workflow', 'run', 'experiment', 'variant', 'grader', 'grader-name', 'grader-source', 'value', 'status', 'included', 'exclusion-reason', 'message', 'error', 'role', 'direction', 'unit', 'threshold', 'rollout-mode', 'maturity-status', 'baseline-value', 'delta-from-baseline', 'evaluator-digest', 'observed-at', 'repository-link', 'run-link', 'evidence-link', 'grader-link'],
