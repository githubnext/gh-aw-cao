...
4. Quality gates validate package dashboard sources; the builder bundles installed package dashboards into the split dashboard shell and page chunks.
