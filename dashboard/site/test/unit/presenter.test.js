...
describe('presenter built-in and custom pages', () => {
    ...
    const rows = [
      {
        ...base,
        run: '1',
        'firewall-observation': '1',
        'firewall-enabled': 'enabled',
        'enforcement-label': 'Enabled',
        'evidence-state': 'no-traffic',
        'evidence-label': 'No observed traffic',
        domain: 'unknown',
        decision: 'unknown',
      ...
      },
      {
        ...base,
        run: '2',
        'firewall-observation': '2',
        'firewall-enabled': 'disabled',
        'enforcement-label': 'Enforcement disabled',
        'evidence-state': 'disabled',
        'evidence-label': 'Enforcement disabled',
        domain: 'unknown',
        decision: 'unknown',
        'decision-label': 'Unknown',
        'drift-state': 'unknown',
        'drift-label': 'Unknown',
        'review-state': 'enforcement-disabled',
        'review-label': 'Enforcement disabled',
        'review-priority': 1,
        'request-count': null,
      },
      {
        ...base,
        run: '3',
        'firewall-observation': '3',
        'firewall-enabled': 'enabled',
        'enforcement-label': 'Enabled',
        'evidence-state': 'unavailable',
        'evidence-label': 'Evidence missing',
        ...
        'drift-state': 'unknown',
        'drift-label': 'Unknown',
        'review-state': 'evidence-missing',
        'review-label': 'Evidence missing',
        'review-priority': 2,
        'request-count': null,
      },
      {
        ...base,
        run: '4',
        'firewall-observation': '4',
        'firewall-enabled': 'enabled',
        'enforcement-label': 'Enabled',
        'evidence-state': 'available',
        'evidence-label': 'Evidence available',
      ...
      },
      {
        ...
        'drift-state': 'newly-allowed',
        'drift-label': 'Newly allowed',
        'review-state': 'newly-allowed',
        'review-label': 'Newly allowed',
        'review-priority': 3,
      },
      {
        ...base,
        run: '6',
        'firewall-observation': '6',
        'firewall-enabled': 'enabled',
        'enforcement-label': 'Enabled',
        'evidence-state': 'available',
        'evidence-label': 'Evidence available',
        ...
        'review-label': 'Stable',
        'review-priority': 9,
        'policy-rule-id': 'default-deny',
      },
      {
        ...base,
        run: '7',
        'firewall-observation': '7',
        'firewall-enabled': 'enabled',
        'enforcement-label': 'Enabled',
        'evidence-state': 'available',
        'evidence-label': 'Evidence available',
        ...
        'current-decision': 'denied',
        'drift-state': 'decision-changed',
        'drift-label': 'Decision changed',
        'review-state': 'decision-changed',
        'review-label': 'Decision changed',
        'review-priority': 4,
      },
    ]
    const rendered = renderDashboard({
          ...
          rows: [
            {
              ...
              'run-conclusion': 'success',
              engine: 'copilot',
              'engine-version': '0.87.6',
              'requested-model': 'gpt-5.6-sol',
              'resolved-model': 'gpt-5.6-sol',
              'run-link': {
                relation: 'run',
                href: 'https://github.com/github/gh-aw-cao/actions/runs/1001',
                label: 'View run 1001',
              },
            },
            {
              ...
              engine: 'copilot',
              'engine-version': '0.87.9',
              'requested-model': 'gpt-5.6-sol',
              'resolved-model': 'gpt-5.6-sol',
              'run-link': {
                relation: 'run',
                href: 'https://github.com/github/gh-aw-cao/actions/runs/1002',
                label: 'View run 1002',
              },
            },
            {
              ...
              'run-link': {
                relation: 'run',
                href: 'https://github.com/github/gh-aw-cao/actions/runs/1003',
                label: 'View run 1003',
              },
            },
          ],
            ...
            views: [
              {
                ...
                mark: 'table',
                encoding: {
                  columns: [{ field: 'organization' }, { field: 'repository' }],
                },
              },
            ],
          },
          ...
          rows: [
            {
              organization: 'githubnext',
              repository: 'gh-aw',
              workflow: '.github/workflows/review.lock.yml',
              'security-feature': 'threat-detection',
              'security-analysis': 'summary',
              'security-signal': 'Malicious patch',
      ...
      sources: {
        outcomes: {
          ...
          rows: [
            {
              package: 'daily',
              'workflow-name': 'Open worker',
              'workflow-role': 'worker',
              'outcome-category': 'issue',
              'outcome-title': 'Open issue',
              'outcome-status': 'open',
              repository: 'control',
              'observed-at': '2026-09-03T10:00:00Z',
            },
            {
              package: 'daily',
              'workflow-name': 'Closed worker',
              'workflow-role': 'worker',
              'outcome-category': 'issue',
              'outcome-title': 'Closed issue',
            ...
            },
            {
              ...
              'outcome-category': 'issue',
              'outcome-title': 'Unattributed issue',
              'outcome-status': 'open',
              repository: 'control',
              'observed-at': '2026-09-03T08:00:00Z',
            },
          ],
        },
      },
      ...
      sources: {
        'run-performance': {
          ...
          rows: [
            ...
            {
              run: '2',
              'started-at': '2026-09-03T11:00:00Z',
        ...
        workflows: {
          ...
          rows: [
            ...
            },
            {
              ...
              'workflow-name': '<img src=x onerror=alert(1)>',
              package: 'release',
          ...
          rows: [
            {
              ...
              'started-at': '2026-08-31T04:00:00Z',
              'run-link': {
                relation: 'run',
            ...
            },
            {
              ...
              run: '102',
              'run-conclusion': 'action-required',
              'started-at': '2026-08-31T05:00:00Z',
              'run-link': {
                relation: 'run',
          ...
          rows: [
            {
              ...
              'external-link': {
                relation: 'external',
                href: 'https://github.com/githubnext/gh-aw-cao/issues/1',
                label: 'View warning output',
              },
            },
            {
              workflow: '.github/workflows/daily.md',
          ...
          rows: [
            {
              ...
              'external-link': {
                relation: 'external',
                href: 'https://github.com/githubnext/gh-aw-cao/issues/1',
                label: 'View pending output',
              },
            },
            {
              'safe-output': 'outcome-2',
              'outcome-state': 'accepted',
              'observed-at': '2026-08-30T04:15:00Z',
            },
          ],
          metadata,
        },
      ...
      sources: {
        ...
        runs: {
          ...
          rows: [
            ...
            },
            {
              ...
              'rollout-mode': 'review',
              engine: 'anthropic',
              'requested-model': 'claude-3.5',
              'resolved-model': 'claude-3.7',
            },
          ],
          metadata: {
            'source-id': 'runs-fixture',
        ...
        outcomes: {
          ...
          rows: [
            {
              package: 'daily-ops',
              'runtime-repository': 'github/gh-aw-cao',
              run: '1001',
              'safe-output': 'daily-output-1',
              'outcome-state': 'accepted',
              'rollout-mode': 'live',
          ...
          rows: [
            {
              ...
              'requested-model': 'gpt-4o',
              'resolved-model': 'gpt-4.1',
              'observed-at': '2026-08-29T10:05:00Z',
            },
            {
              repository: 'gh-aw-cao',
              workflow: '.github/workflows/daily.yml',
              ...
              'requested-model': 'gpt-4o',
              'resolved-model': 'gpt-4.1',
              'observed-at': '2026-08-29T11:05:00Z',
            },
            {
              repository: 'gh-aw-cao',
              workflow: '.github/workflows/review.yml',
              ...
              'requested-model': 'claude-3.5',
              'resolved-model': 'claude-3.7',
              'observed-at': '2026-08-29T12:05:00Z',
            },
          ],
          metadata: {
            'source-id': 'usage-fixture',
          ...
          rows: [
            {
              ...
              'issue-link': {
                relation: 'issue',
                href: 'https://example.com/issues/2',
                label: 'Issue 2',
              },
              'pull-request-link': {
                relation: 'pull-request',
                href: 'https://example.com/pulls/2',
                label: 'PR 2',
              },
              'run-link': {
                relation: 'run',
                href: 'https://example.com/runs/1003',
                label: 'Run 1003',
              },
            },
            {
              ...
              'pull-request-link': {
                relation: 'pull-request',
                href: 'https://example.com/pulls/1',
                label: 'PR 1',
              },
              'run-link': {
                relation: 'run',
                href: 'https://example.com/runs/1002',
                label: 'Run 1002',
              },
            },
          ],
        ...
        'operational-values': {
          ...
          rows: [
            ...
            },
            {
              ...
              'evidence-link': {
                relation: 'evidence',
                href: 'https://example.com/evidence/2',
                label: 'Evidence 2',
              },
            },
          ],
      ...
      sources: {
        workflows: {
          ...
          rows: [
            ...
            {
              package: 'empty-ops',
              'package-name': 'Empty Ops',
              workflow: '.github/workflows/empty.md',
              'workflow-role': 'orchestrator',
              'rollout-mode': 'live',
              'max-ai-credits': 80,
              'inventory-ready': true,
          ...
          rows: [
            {
              workflow: '.github/workflows/daily.md',
              run: '1',
              'started-at': '2026-08-28T10:00:00Z',
              'run-conclusion': 'success',
              'rollout-mode': 'review',
            },
            {
              workflow: '.github/workflows/unmanaged.md',
              run: '3',
              'started-at': '2026-08-29T11:00:00Z',
          ...
          rows: [
            {
              ...
              'run-conclusion': 'success',
              'rollout-mode': 'review',
              'published-at': '2026-08-28T10:00:00Z',
            ...
            },
            {
              ...
              run: '2',
              'rollout-mode': 'live',
              'published-at': '2026-08-29T10:00:00Z',
              'observed-at': '2026-08-29T10:05:00Z',
            },
            {
              package: 'daily-ops',
              ...
              'rollout-mode': 'live',
              'published-at': '2026-08-29T10:00:00Z',
              'observed-at': '2026-08-29T10:06:00Z',
            },
            {
              package: 'daily-ops',
              run: 'old',
              'run-conclusion': 'success',
              'rollout-mode': 'review',
              'published-at': '2026-07-01T10:00:00Z',
              'observed-at': '2026-07-01T10:00:00Z',
            },
          ],
          metadata,
        },
  ...
  it('DLS-SEM-022 DLS-SEM-023 DLS-PAGE-014 DLS-PAGE-015 keeps packages repository-scoped and distinguishes unknown or unavailable telemetry', () => {
    ...
    const usage = {
      ...
      metadata: {
        ...metadata,
        completeness: /** @type {'unknown'} */ ('unknown'),
      },
    }
        ...
        pages: [
          {
            ...
            definition: {
              ...
              views: [
                {
                  id: 'runs-table',
                  title: 'Runs Inventory First',
                  data: { source: 'runs' },
                },
                {
                  id: 'runs-status',
                  title: 'Run Status Second',
                  data: { source: 'runs' },
                },
                {
                  id: 'outcome-counts',
                  title: 'Outcome Counts Third',
                  data: { source: 'outcomes' },
                },
                {
                  id: 'run-conclusions',
                  title: 'Run Conclusions Fourth',
                  data: { source: 'runs' },
                },
              ],
            },
      ...
      sources: {
        evals: {
          ...
          rows: [
            {
              eval: 'release-risk',
              'eval-name': 'Release Risk',
              'eval-question': 'Is the release risky?',
              'requested-model': 'gpt-4o',
              'observed-at': '2026-08-29T09:00:00Z',
            },
            {
              eval: 'doc-quality',
              'eval-name': 'Documentation Quality',
              'eval-question': 'Is the documentation complete?',
              'requested-model': 'claude-3.5',
              'observed-at': '2026-08-29T09:05:00Z',
            },
          ],
        ...
        'eval-observations': {
          ...
          rows: [
            ...
            },
            {
              ...
              'resolved-model': 'claude-3.7',
              'rollout-mode': 'review',
              'observed-at': '2026-08-29T10:20:00Z',
            },
          ],
          metadata: {
        ...
        pages: [
          {
            ...
            definition: {
              ...
              views: [{ id: 'findings-source', data: { source: 'findings' } }],
            },
          },
        ],
      },
          ...
          rows: [
            {
              ...
              'run-link': {
                relation: 'run',
                href: 'https://github.com/github/central-agentic-ops/actions/runs/1001',
                label: 'Run 1001',
              },
            },
            {
              ...
              'run-link': {
                relation: 'run',
                href: 'https://github.com/github/central-agentic-ops/actions/runs/1002',
                label: 'Run 1002',
              },
            },
          ],
          ...
          rows: [
            {
              ...
              run: '1',
              'run-count': 2,
              'started-at': '2026-08-28T00:00:00Z',
              'run-conclusion': 'success',
            },
            {
              organization: 'octo-org',
              ...
              run: '2',
              'run-count': 3,
              'started-at': '2026-08-29T00:00:00Z',
              'run-conclusion': 'failure',
            },
          ],
          metadata: {
          ...
          rows: [
            {
              run: '1',
              'run-conclusion': 'success',
              'run-link': { href: 'javascript:alert(1)', label: 'Unsafe' },
            },
            {
              run: '2',
              'run-conclusion': 'failure',
              'run-link': {
                href: 'https://example.com/runs/2',
                label: 'Run 2',
              },
            },
          ],
          ...
          rows: [
            {
              run: '1',
              'run-link': {
                href: 'https://user:secret@example.com/runs/1',
                label: 'Credentialed Run',
              },
            },
            {
              run: '2',
              'run-link': {
                href: 'ftp://example.com/runs/2',
                label: 'FTP Run',
              },
            },
            {
              run: '3',
              'run-link': { href: 'https://example.com/runs/3', label: '   ' },
            },
            {
              run: '4',
              'run-link': {
                href: 'https://example.com/runs/4',
                label: 'Run 4',
              },
            },
          ],
