    ...
    sources['operational-values'] = {
      ...
      rows: [
        ...
        },
        {
          ...
          diagnostics: {
            'repository-health': 0.4,
            'oversized-file-share': 0.8,
            currentLines: 1907,
          },
          'diagnostic-definitions': [
            ...
            {
              id: 'oversized-file-share',
              name: 'Oversized file share',
        ...
        },
        {
          ...
          diagnostics: {
            'repository-health': 0.65,
            'oversized-file-share': 0.5,
          },
          'diagnostic-definitions': [
            {
              id: 'repository-health',
          ...
          'run-link': {
            relation: 'run',
            href: 'https://github.com/githubnext/gh-aw-cao/actions/runs/2',
            label: 'Run 2',
          },
          'evidence-link': {
            relation: 'evidence',
