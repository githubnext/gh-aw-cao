...
describe('Pages health collector', () => {
  ...
  it('builds encoded hash routes without losing the site base path', () => {
    expect(routeUrl('https://example.test/base/', 'cost center')).toBe(
      'https://example.test/base/#page-cost%20center',
    )
  })
  ...
  it('defines desktop, mobile, and constrained-network Lighthouse profiles', () => {
    ...
    if (!desktop || !lowBandwidth)
      throw new Error('Expected Pages health profiles')
