...
describe('UI elements', () => {
  it('renders source-backed JSON in declarative code regions', () => {
    const rendered = renderUiElement('code-region', {
      pageId: 'data-health',
      viewId: 'data-health-schema',
      title: 'Data shape preview',
      sourceNames: ['data-health-schema'],
      sources: {
        'data-health-schema': {
