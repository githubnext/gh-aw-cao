        ...
        rows: [
          {
            ...
            'outcome-body-html':
              '<h2>Summary</h2><ul><li>Passed</li></ul><table><thead><tr><th scope="colgroup">Checks</th></tr></thead></table><script>window.bad = true</script><a href="javascript:alert(1)" onclick="alert(1)">unsafe</a>',
