...
describe('table cell display helper', () => {
  it('DLS-VIEW-004 renders JSON-selected display types through one generic helper', () => {
    ...
    const workflowRun = /** @type {HTMLAnchorElement} */ (
      renderCellDisplay(undefined, 'https://github.com/githubnext/gh-aw-cao/actions/runs/12345', toText, null, 'nominal', 'workflow-run-url')
    )
    ...
    expect(renderCellDisplay(undefined, 'https://example.com/actions/runs/12345', toText, null, 'nominal', 'workflow-run-url')).toBe(
