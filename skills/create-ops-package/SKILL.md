...
- Install `.github/workflows/cao-dashboard-build.yml` in place and `dashboard/cao-dashboard.yml` as `.github/workflows/cao-dashboard.yml` with mapped `action-workflow` includes.
