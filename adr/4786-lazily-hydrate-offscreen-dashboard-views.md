...
The change includes `.github/aw/dashboard/aw.yml`, `.github/aw/dashboard/site/index.html`, the new `.github/aw/dashboard/site/src/components/lazy-view.js` component, `.github/aw/dashboard/site/src/presenter.js`, `.github/aw/dashboard/site/src/styles.js`, and updated dashboard tests.
