...
The change includes `.github/cao/dashboard/aw.yml`, `.github/cao/dashboard/site/index.html`, the new `.github/cao/dashboard/site/src/components/lazy-view.js` component, `.github/cao/dashboard/site/src/presenter.js`, `.github/cao/dashboard/site/src/styles.js`, and updated dashboard tests.
