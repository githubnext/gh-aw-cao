...
test.describe('local-server HTTP response headers', () => {
  test('index.html serves correct Content-Type and Cache-Control', async ({
    request,
  }) => {
  ...
  test('dashboard.json serves JSON with no-store cache', async ({
    request,
  }) => {
  ...
  test('non-GET/HEAD methods return 405 with Allow header', async ({
    request,
  }) => {
