...
// Reusing one browser context lets every selected page share the downloaded
// canonical projection. Keep the complete assessment within two minutes.
export const dashboardAssessmentStartupBudgetMs = 60_000;
export const dashboardAssessmentPageBudgetMs = 5_000;
export const maximumDashboardAssessmentTimeoutMs = 120_000;
