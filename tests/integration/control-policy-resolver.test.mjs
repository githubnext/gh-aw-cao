...
const schemaUri =
  'https://raw.githubusercontent.com/githubnext/gh-aw-cao/main/.github/cao/cao.schema.json'
...
function expectFailure(result, expected) {
  assert.notEqual(
    result.status,
    0,
    `expected failure, received stdout:\n${result.stdout}`,
  )
  assert.ok(
...
const rawPolicyViolations = [
  ...
  [
    'duplicate keys',
    '{"version":1,"version":1,"control-plane":{}}',
...
const policyViolations = [
  ...
  [
    ...
    'version must be an integer in 1..1',
  ],
  [
  ...
  [
    'non-mapping control planes',
    (value) => {
      value['control-plane'] = []
    },
    'control-plane must be a mapping',
  ],
  [
    'unknown control-plane properties',
    (value) => {
  ...
  [
    'non-mapping scopes',
    (value) => {
      value['control-plane'].scope = []
    },
    'control-plane.scope must be a mapping',
  ],
  [
    'unknown scope properties',
    (value) => {
  ...
  [
    'non-array allowed repositories',
    (value) => {
  ...
  [
    'malformed allowed repositories',
    (value) => {
      value['control-plane'].scope['allowed-repositories'] = [
        'not-a-repository',
      ]
    },
  ...
  [
    'duplicate allowed repositories',
    (value) => {
      value['control-plane'].scope['allowed-repositories'] = [
        'acme/target',
        'ACME/TARGET',
  ...
  [
    ...
    (value) => {
      value['control-plane'].inventory = []
    },
    'control-plane.inventory must be a mapping',
  ],
  [
    'unknown inventory properties',
    (value) => {
  ...
  [
    'cell indexes outside the cell count',
    (value) => {
  ...
  [
    'non-mapping defaults',
    (value) => {
      value['control-plane'].defaults = []
    },
    'control-plane.defaults must be a mapping',
  ],
  [
  ...
  [
    'invalid default repository limits',
    (value) => {
  ...
  [
    'invalid default rollout percentages',
    (value) => {
  ...
  [
    ...
    (value) => {
      value['control-plane'].packages = []
    },
    'control-plane.packages must be a mapping',
  ],
  [
    'malformed package slugs',
    (value) => {
  ...
  [
    'invalid package repository limits',
    (value) => {
  ...
  [
    'invalid package rollout percentages',
    (value) => {
  ...
  [
    'negative package budgets',
    (value) => {
      value['control-plane'].packages.operations['monthly-ai-credit-budget'] =
        -1
    },
    'control-plane.packages.operations.monthly-ai-credit-budget must be an integer in >= 0',
  ],
  [
    'non-mapping package targets',
    (value) => {
  ...
  [
    'malformed target repository names',
    (value) => {
      value['control-plane'].packages.operations.targets = {
        invalid: { mode: 'live' },
      }
  ...
  [
    'malformed worker slugs',
    (value) => {
      value['control-plane'].packages.operations.workers['Not Valid'] = {
        workflow: 'operations-worker',
      }
    },
    'control-plane.packages.operations.workers.Not Valid has an invalid value',
  ],
  [
    'non-mapping worker policies',
    (value) => {
  ...
  [
    'unknown worker properties',
    (value) => {
      value['control-plane'].packages.operations.workers.auditor.unexpected =
        true
    },
    'unknown key control-plane.packages.operations.workers.auditor.unexpected',
  ],
  [
    'workers without workflows',
    (value) => {
  ...
  [
    'malformed worker workflows',
    (value) => {
      value['control-plane'].packages.operations.workers.auditor.workflow =
        'Not Valid'
    },
    'control-plane.packages.operations.workers.auditor.workflow has an invalid value',
  ],
  [
    'duplicate worker workflows',
    (value) => {
      value['control-plane'].packages.operations.workers.secondary = {
        workflow: 'operations-auditor',
      }
    },
  ...
  [
    'non-boolean worker switches',
    (value) => {
      value['control-plane'].packages.operations.workers.auditor.enabled =
        'true'
    },
    'control-plane.packages.operations.workers.auditor.enabled must be a Boolean',
  ],
  [
    'invalid worker mode ceilings',
    (value) => {
      value['control-plane'].packages.operations.workers.auditor['max-mode'] =
        'preview'
    },
    'control-plane.packages.operations.workers.auditor.max-mode must be review or live',
  ],
  [
    'non-mapping publishing policies',
    (value) => {
  ...
  [
    'non-boolean publishing switches',
    (value) => {
  ...
  [
    'non-array publishing repositories',
    (value) => {
  ...
  [
    'malformed publishing repositories',
    (value) => {
  ...
  [
    'duplicate publishing repositories',
    (value) => {
      value['control-plane'].publishing['control-repositories'] = [
        'acme/control',
        'ACME/CONTROL',
      ]
    },
  ...
  [
    'non-array publishing reviewers',
    (value) => {
  ...
  [
    'malformed publishing reviewers',
    (value) => {
  ...
  [
    'duplicate publishing reviewers',
    (value) => {
  ...
  [
    'enabled publishing without reviewers',
    (value) => {
  ...
  [
    'unknown target-authority properties',
    (value) => {
  ...
  [
    'target authority without packages',
    (value) => {
  ...
  [
    'non-mapping target-authority packages',
    (value) => {
  ...
  [
    'malformed target-authority package slugs',
    (value) => {
      value['target-authority'].packages['Not Valid'] = {
  ...
  [
    'non-mapping target package policies',
    (value) => {
  ...
  [
    'unknown target package properties',
    (value) => {
  ...
  [
    'target packages without authorities',
    (value) => {
  ...
  [
    'malformed target package authorities',
    (value) => {
...
const effectivePolicyViolations = [
  ...
  [
    'workers without identities',
    { CAO_ROLE: 'worker' },
    'worker identity is required',
  ],
  [
    'orchestrators with worker identities',
    { CAO_WORKER: 'auditor' },
    'worker identity is forbidden for orchestrators',
  ],
  [
    'undeclared workers',
    { CAO_ROLE: 'worker', CAO_WORKER: 'unknown' },
    'unknown worker: operations/unknown',
  ],
  [
    'malformed target repositories',
    { CAO_TARGET_REPOSITORY: 'invalid' },
    'target_repo must use owner/repository form',
  ],
  [
    'invalid requested modes',
    { CAO_REQUESTED_MODE: 'preview' },
    'safe_output_mode must be review or live',
  ],
  [
    'requested mode widening',
    { CAO_REQUESTED_MODE: 'live' },
    'safe_output_mode exceeds checked-in policy',
  ],
  [
    'invalid requested repository limits',
    { CAO_REQUESTED_MAX_REPOSITORIES: '0' },
    'max_repositories must be an integer in 1..1000',
  ],
  [
    'requested repository-limit widening',
    { CAO_REQUESTED_MAX_REPOSITORIES: '9' },
    'max_repositories exceeds checked-in policy',
  ],
  [
    'invalid requested rollout percentages',
    { CAO_REQUESTED_ROLLOUT_PERCENT: '0' },
    'rollout_percent must be an integer in 1..100',
  ],
  [
    'requested rollout widening',
    { CAO_REQUESTED_ROLLOUT_PERCENT: '51' },
    'rollout_percent exceeds checked-in policy',
  ],
]
...
for (const [name, environment, expected] of effectivePolicyViolations) {
  test(`control.mjs resolve-policy rejects ${name}`, () => {
    expectFailure(
      run(['resolve-policy', '-'], JSON.stringify(policy()), environment),
      expected,
    )
  })
}
...
test('control.mjs control-settings rejects malformed control repository identity', () => {
  expectFailure(
    run(['control-settings', '-'], JSON.stringify(policy()), {
...
test('control.mjs control-settings requires a control-plane policy', () => {
  ...
  expectFailure(
    run(['control-settings', '-'], JSON.stringify(source)),
...
test('control.mjs rejects missing policy files', () => {
  expectFailure(
    run(['validate-policy', join(root, 'missing-policy.json')]),
    'ENOENT',
  )
})
