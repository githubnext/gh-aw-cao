...
const caoEvolutionExpectedFiles = [
  ".github/aw/cao-evolution/graders/aw-failures-investigator-operational-value.sh",
  ".github/aw/cao-evolution/graders/aw-maintenance-compiler-security-operational-value.sh",
