...
const caoEvolutionExpectedFiles = [
  ...
  ".github/aw/cao-evolution/graders/cao-evolution-agents-md-curator-operational-value.sh",
  ".github/aw/cao-evolution/graders/cao-evolution-ai-credit-auditor-operational-value.sh",
  ".github/aw/cao-evolution/graders/cao-evolution-ai-credit-optimizer-operational-value.sh",
  ".github/aw/dashboards/cao-evolution.json",
  ".github/aw/dashboards/cao-evolution-optimization.json",
  ...
  ".github/workflows/graders/cao-evolution-agents-md-curator-operational-value.sh",
  ".github/workflows/graders/cao-evolution-ai-credit-auditor-operational-value.sh",
  ".github/workflows/graders/cao-evolution-ai-credit-optimizer-operational-value.sh",
