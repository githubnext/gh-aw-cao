...
test("selects the page that uses a changed component", () => {
  assert.deepEqual(selectAffectedPageIds({
    dashboard,
    changedFiles: [".github/cao/dashboard/site/src/components/configuration-actions.js"],
    baseRef: "unused",
  }), ["cost"]);
});
...
test("selects every page for shared renderer changes", () => {
  assert.deepEqual(selectAffectedPageIds({
    dashboard,
    changedFiles: [".github/cao/dashboard/site/src/presenter.js"],
    baseRef: "unused",
  }), ["experiments", "cost"]);
});
...
test("selects every page for components with transitive consumers", () => {
  assert.deepEqual(selectAffectedPageIds({
    dashboard,
    changedFiles: [".github/cao/dashboard/site/src/components/agent-marketplace-view.js"],
    baseRef: "unused",
  }), ["experiments", "cost"]);
});
...
test("selects every page when a referenced component was deleted", () => {
  assert.deepEqual(selectAffectedPageIds({
    ...
    changedFiles: [".github/cao/dashboard/site/src/components/deleted-component.js"],
    baseRef: "unused",
