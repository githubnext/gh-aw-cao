...
test("operational-value record detection accepts native and legacy results only", () => {
  assert.equal(hasOperationalValueResult({ resultAvailable: true }), true);
  assert.equal(hasOperationalValueResult({ resultAvailable: false, observation: { evidenceAt: "2026-09-01T00:00:00Z" } }), true);
