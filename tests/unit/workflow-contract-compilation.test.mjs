...
test("clean-room compilation emits the expected GitHub Actions settings", { timeout: 120_000 }, () => {
  ...
  try {
    ...
    for (const packageDirectory of ["cao-evolution", "dashboard", "dependabot", "optimization"]) {
      cpSync(join(root, packageDirectory), join(temporaryRoot, packageDirectory), { recursive: true });
    }
    for (const manifest of ["aw.yml", ".github/aw/activity/aw.yml", "cao-evolution/aw.yml", "dashboard/aw.yml", "dependabot/aw.yml", "optimization/aw.yml"]) {
