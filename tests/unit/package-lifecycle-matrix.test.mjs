...
test("package lifecycle matrix selects only packages owning changed files", () => {
  ...
  assert.deepEqual(names([".github/graders/dependabot-release-train-updater-operational-value.sh"]), ["root", "Dependabot"]);
  assert.deepEqual(names([".github/graders/aw-maintenance-compiler-security-operational-value.sh"]), ["root", "AW Doctor"]);
});
