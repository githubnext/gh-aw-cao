...
for (const [name, policy, error] of [
  ...
  ["unknown nested keys", '{"version":1,"gh-aw-version":"v0.89.11","control-plane":{"packages":{"dependabot":{"surprise":true}}}}', /unknown key control-plane.packages.dependabot.surprise/],
