...
test("enterprise defaults, budgets, timeouts, and concurrency are finite", () => {
  const expected = {
    ...
    "cao-evolution-agents-md-curator.md": { credits: 400, timeout: 25 },
    "cao-evolution-skills-curator.md": { credits: 400, timeout: 20 },
    ...
    "cao-evolution-ai-credit-auditor.md": { credits: 350, timeout: 35 },
    "cao-evolution-ai-credit-optimizer.md": { credits: 500, timeout: 30 },
...
test("live workers use central policy as the activation authority", () => {
  ...
  for (const [name, bundle] of [
    ...
    ["cao-evolution-agents-md-curator.md", "optimization"],
    ["cao-evolution-skills-curator.md", "optimization"],
    ...
    ["cao-evolution-ai-credit-auditor.md", "optimization"],
    ["cao-evolution-ai-credit-optimizer.md", "optimization"],
