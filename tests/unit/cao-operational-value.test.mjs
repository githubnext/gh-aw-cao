...
for (const repository of request.repositories) {
  ...
  console.log(JSON.stringify({timestamp:request.timestamp,repository,valueId:"example-count",value:isolated ? 2 : 0,metricRole:"diagnostic",metricName:"Example count",metricDirection:"decrease",maturityStatus:"interim",adoptionAt:"2026-09-15T23:30:36Z"}));
}\n`);
  ...
  assert.deepEqual(
    ...
    [
      { role: 'diagnostic', name: 'Example count', direction: 'decrease', maturity: 'interim', adoptionAt: '2026-09-15T23:30:36.000Z' },
      { role: 'diagnostic', name: 'Example count', direction: 'decrease', maturity: 'interim', adoptionAt: '2026-09-15T23:30:36.000Z' },
    ],
  );
});
