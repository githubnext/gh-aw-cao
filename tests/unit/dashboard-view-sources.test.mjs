...
import { effectiveDashboardSources, missingDashboardSources } from "../e2e/dashboard-view-sources.mjs";
...
test("dashboard view assessment still reports unavailable derived sources", () => {
  ...
  assert.deepEqual(missingDashboardSources({ data: { source: "workflow-reports" } }, sources), ["workflow-reports: missing or unavailable"]);
});
