...
2. `.github/aw/dashboard/report/records.mjs`, executed by the activity action, normalizes durable issues, pull requests, comments, review artifacts, and run attribution.
3. `.github/aw/dashboard/report/dashboard-language-sources.mjs` adapts collector and record data into `sources.json`.
