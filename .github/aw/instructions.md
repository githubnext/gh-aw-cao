...
- Keep report source modules under `.github/cao/dashboard/report/` and install them under `.github/cao/dashboard/report/` through matching root and `.github/cao/dashboard/aw.yml` resources.
...
- Keep the production renderer under `.github/cao/dashboard/site/` and install its runtime assets under `.github/cao/dashboard/site/` through matching root and `.github/cao/dashboard/aw.yml` resources.
