...
`.github/cao/activity/cao.mjs` logs shard skip/ingest decisions and per-file hash results
through Node's built-in `util.debuglog` (see `.github/cao/activity/debug.mjs`), scoped
