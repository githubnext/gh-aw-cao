...
- Separately ask whether the user wants to create an operation package of their own. When they do, record the operation idea and hand it to `.github/skills/create-cao-package/SKILL.md` after the base control-plane boundary is proven; setup must not improvise a standalone custom workflow.
