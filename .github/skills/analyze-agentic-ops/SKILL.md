...
When a workflow has restored the CAO activity cache, use `${RUNNER_TEMP}/cao-activity/gh-aw-logs.sqlite` directly. Do not download another copy or parse the sibling JSONL. Otherwise:
