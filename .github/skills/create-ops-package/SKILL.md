...
- Every orchestrator inherits the dedicated `central-agentic-ops.orchestrator.run` OTEL span from `shared/orchestrator.md`. Do not duplicate orchestrator telemetry in package workflows.
