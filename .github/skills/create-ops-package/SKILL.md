...
- Every orchestrator inherits the dedicated `central-agentic-ops.dispatcher.run` OTEL span from `shared/orchestrator.md`; do not duplicate orchestrator telemetry in package workflows.
