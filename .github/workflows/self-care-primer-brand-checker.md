...
This repository contains a static dashboard renderer under `.github/aw/dashboard/site/`.

- `.github/aw/dashboard/site/index.html` — page shell and initial markup
- `.github/aw/dashboard/site/src/styles.js` — dashboard theme tokens and component styles
- `.github/aw/dashboard/site/src/presenter.js` and `.github/aw/dashboard/site/src/components/` — generated UI markup
- `.github/aw/dashboard/site/test/` — unit and browser coverage
...
Review `.github/aw/dashboard/site/index.html`, `.github/aw/dashboard/site/src/styles.js`, and the markup produced by `.github/aw/dashboard/site/src/presenter.js` and `.github/aw/dashboard/site/src/components/` for deviations from the retrieved guidance, focusing on:
...
2. Run all dashboard validation commands:
   ...
   npm --prefix .github/aw/dashboard/site run build
   ```
...
- Do NOT change `.github/aw/dashboard/aw.yml`, report producers, documentation, agentic workflows, or files outside the configured safe-output allowlist.
