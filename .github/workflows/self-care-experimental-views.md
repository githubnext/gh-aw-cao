...
5. Exercise every in-scope view with Playwright in both Chromium and WebKit. Use temporary fixtures only under `/tmp`; do not add an audit harness or generated evidence to the repository.
