...
imports:
  - uses: shared/control.md
    with:
      ...
      worker_credits_per_target: 5100
...
- `self-care-server-debug-logging`: instruments one eligible production Go server file with DEBUG-controlled, privacy-preserving logging and focused tests, then opens one focused draft pull request.
...
In `Outcome`, additionally state whether the sole authorized live target was selected, whether every non-cadence-limited SelfCare worker was dispatched, whether the dashboard data schema and glossary workers were daily-eligible and dispatched, and whether the Pages Health worker was six-hour-eligible and dispatched.
