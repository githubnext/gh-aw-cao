...
- `self-care-reactive-ui-expert`: maintains the reactive UI skill, reviews recent dashboard JavaScript changes, and replaces evidenced imperative DOM updates with owned reactive elements, data binding, and effects.
