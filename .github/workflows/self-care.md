...
imports:
  - uses: shared/control.md
    with:
      ...
      worker_credits_per_target: 3800
...
The single eligible repository contains the documentation site and dashboard maintained by the twelve workers. Do not discover, rank, or dispatch work to any other repository.
...
In `Outcome`, additionally state whether the sole authorized live target was selected, whether all ten regular SelfCare workers were dispatched, whether the glossary worker was daily-eligible and dispatched, and whether the Pages Health worker was six-hour-eligible and dispatched.
