  ...
  workflow_dispatch:
    inputs:
      ...
      token_efficiency_candidates_json:
        description: Frozen eligible rows from the token-efficiency-portfolio-candidates Dashboard Language query
        type: string
  permissions:
    contents: read
    actions: read
