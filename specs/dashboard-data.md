...
| --- | ---: | --- |
| Canonical model | 18 | Campaign, Repository, Workflow, Run, Domain, Tool, Audit, Issue, and Operational Value records |
| Browser IndexedDB | 26 | Nine canonical entity stores, `transactions`, `dailyOverviewAggregates`, and `overviewAggregateMetadata` |
