...
| T-CAOD-INT-001 | CAOD-INT-001 through 011 | 1 | Exercise state, reason, cost, refresh, pending, destructive, and live interactions plus in-place inspection and temporal scrubbing; verify direct evidence routes, confirmation, preserved subject context, and unchanged underlying observations. |
| T-CAOD-INT-002 | CAOD-INT-009 through 011 | 1 | Load with and without compatible cached data, advance the refresh clock by 15 minutes, and publish changed, unchanged, and invalid generations; verify unique cache-busting query arguments, bounded incremental persistence, non-overlap, progress indication, atomic activation, active subscribed-view updates without page reload or navigation, context preservation, successful no-op behavior, and stale prior-generation recovery. |
